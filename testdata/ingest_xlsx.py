...
def main():
    ...
    ingest_xlsx(corpus_dir, output_dir, xlsx_metadata_file, manifest_format)
...
def ingest_xlsx(corpus_dir, output_dir, xlsx_metadata_file, manifest_format):
    xlsx_ingester = XLSXIngester(corpus_dir, output_dir, xlsx_metadata_file, manifest_format)
    xlsx_ingester.create_n3()
